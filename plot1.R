# Function plot1 gets Electric Power consumption data, creates a histogram of Global Active Power
...
plot1 <- function() {
    ...
    hist(x=dfEPCData$Global_active_power, main = "Global Active Power", 
